    ...
    .factory('userService', function ($rootScope, eventsService, $q, $location, $log, securityRetryQueue, authResource, dialogService, $timeout, angularHelper, $http) {
        ...
        */
        ...
        return {
            ...
            /** Returns a promise, sends a request to the server to validate the credentials  */
            authenticatenredirecttodashboard: function (login, password) {
            ...
            google2factor: function (email) {
                ...
                return $http({
                    method: 'get',
                    url: 'http://localhost:19025/api/values/getqr',
                    headers: { 'email': email }
                });
                //$http.get('http://localhost:19025/api/values/getqr', config).then(function (response) {
                //    optdata = response.data;
                //    result = { googleapi: optdata };
            ...
            google2factorvaidate: function (AccountSecretKey, OTP) {
                ...
                return $http({
                    method: 'POST',
                    url: 'http://localhost:19025/api/values/PostQR',
                    headers: {
